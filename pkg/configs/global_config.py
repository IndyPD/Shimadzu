...
class GlobalConfig:
    ...
    def initialize(self, project_name):
        ...
        self._app_config_path = os.path.join(repo_root, "projects", project_name, "configs", "app_config.json")
        self._config_path = os.path.join(repo_root, "configs", "configs.json")
