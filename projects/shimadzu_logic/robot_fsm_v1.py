    ...
    def _setup_rules(self):
        ...
        self._rule_table = {
            ...
            RobotState.READY: {
                RobotEvent.VIOLATION_DETECT: RobotState.ERROR,
                RobotEvent.STOP_EMG: RobotState.STOP_AND_OFF,
                RobotEvent.DO_AUTO_MOTION_PROGRAM_AUTO_ON: RobotState.PROGRAM_AUTO_ON,
                RobotEvent.RECOVER: RobotState.RECOVERING,
            },
            ...
            RobotState.AUTO_MOTION_RETRACT_FROM_TENSILE: {
                RobotEvent.AUTO_MOTION_RETRACT_FROM_TENSILE_DONE: RobotState.WAIT_AUTO_COMMAND,
                RobotEvent.VIOLATION_DETECT: RobotState.ERROR,
            },
            ...
            RobotState.AUTO_MOTION_RETRACT_FROM_SCRAP: {
                RobotEvent.AUTO_MOTION_RETRACT_FROM_SCRAP_DONE: RobotState.WAIT_AUTO_COMMAND,
                RobotEvent.VIOLATION_DETECT: RobotState.ERROR,
            },
        }
